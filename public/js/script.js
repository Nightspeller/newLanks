...
function initializeTracking() {
    ...
    $('#tracking-form').on('submit', function (event) {
        ...
        alert('Доставка заказов Орифлэйм во втором каталоге переносится с 31.01.2017 г. на 01.02.2017 г. По всем вопросам о переносе доставки просим обращаться в колцентр Орифлэйм по телефону 8-800-775-44-44');
    })
}
